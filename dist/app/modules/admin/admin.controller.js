...
const createAdmin = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield admin_service_1.AdminService.createAdminToDB(adminData);
...
const adminLogin = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const adminLoginData = __rest(req.body, []);
    const result = yield admin_service_1.AdminService.adminLoginToDB(adminLoginData);
